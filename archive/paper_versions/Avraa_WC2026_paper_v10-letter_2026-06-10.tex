...
\toprule
 & Team & \worldflag[width=4mm]{MX} & \worldflag[width=4mm]{KR} & \worldflag[width=4mm]{CZ} & \worldflag[width=4mm]{ZA} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{MX}~\textbf{Mexico} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & \shortstack{1--0\\[-1pt]{\tiny 0.90}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & 3 & 0 & $+$3 & \textbf{9} \\
2 & \worldflag[width=4mm]{KR}~\textbf{South Korea} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & \shortstack{1--1\\[-1pt]{\tiny 0.74}} & \shortstack{1--0\\[-1pt]{\tiny 0.79}} & 1 & 1 & 0 & \textbf{4} \\
3 & \worldflag[width=4mm]{CZ}~Czechia & \shortstack{0--1\\[-1pt]{\tiny 0.90}} & \shortstack{1--1\\[-1pt]{\tiny 0.74}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.84}} & 1 & 1 & 0 & 4 \\
4 & \worldflag[width=4mm]{ZA}~South Africa & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--1\\[-1pt]{\tiny 0.79}} & \shortstack{0--1\\[-1pt]{\tiny 0.84}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{CH} & \worldflag[width=4mm]{CA} & \worldflag[width=4mm]{BA} & \worldflag[width=4mm]{QA} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{CH}~\textbf{Switzerland} & --- & \shortstack{2--1\\[-1pt]{\tiny 0.80}} & \shortstack{1--0\\[-1pt]{\tiny 1.03}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & 3 & 0 & $+$3 & \textbf{9} \\
2 & \worldflag[width=4mm]{CA}~\textbf{Canada} & \shortstack{1--2\\[-1pt]{\tiny 0.80}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.90}} & \shortstack{1--0\\[-1pt]{\tiny 1.12}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=4mm]{BA}~Bosnia and Herzegovina & \shortstack{0--1\\[-1pt]{\tiny 1.03}} & \shortstack{0--1\\[-1pt]{\tiny 0.90}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=4mm]{QA}~Qatar & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--1\\[-1pt]{\tiny 1.12}} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{BR} & \worldflag[width=4mm]{MA} & \flagSCO[4mm] & \worldflag[width=4mm]{HT} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{BR}~\textbf{Brazil} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.97}} & \shortstack{1--0\\[-1pt]{\tiny 1.05}} & \shortstack{2--0\\[-1pt]{\tiny 1.37}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=4mm]{MA}~\textbf{Morocco} & \shortstack{0--1\\[-1pt]{\tiny 0.97}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.90}} & \shortstack{1--0\\[-1pt]{\tiny 1.28}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \flagSCO[4mm]~Scotland & \shortstack{0--1\\[-1pt]{\tiny 1.05}} & \shortstack{0--1\\[-1pt]{\tiny 0.90}} & --- & \shortstack{1--0\\[-1pt]{\tiny 1.00}} & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=4mm]{HT}~Haiti & \shortstack{0--2\\[-1pt]{\tiny 1.37}} & \shortstack{0--1\\[-1pt]{\tiny 1.28}} & \shortstack{0--1\\[-1pt]{\tiny 1.00}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{US} & \worldflag[width=4mm]{TR} & \worldflag[width=4mm]{PY} & \worldflag[width=4mm]{AU} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{US}~\textbf{United States} & --- & \shortstack{1--1\\[-1pt]{\tiny 0.68}} & \shortstack{1--0\\[-1pt]{\tiny 0.86}} & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & 2 & 0 & $+$2 & \textbf{7} \\
2 & \worldflag[width=4mm]{TR}~\textbf{Turkey} & \shortstack{1--1\\[-1pt]{\tiny 0.68}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.82}} & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & 2 & 0 & $+$2 & \textbf{7} \\
3 & \worldflag[width=4mm]{PY}~Paraguay & \shortstack{0--1\\[-1pt]{\tiny 0.86}} & \shortstack{0--1\\[-1pt]{\tiny 0.82}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.85}} & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=4mm]{AU}~Australia & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & \shortstack{0--1\\[-1pt]{\tiny 0.85}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{DE} & \worldflag[width=4mm]{EC} & \worldflag[width=4mm]{CI} & \worldflag[width=4mm]{CW} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{DE}~\textbf{Germany} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & \shortstack{1--0\\[-1pt]{\tiny 1.04}} & \shortstack{3--0\\[-1pt]{\tiny 1.32}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=4mm]{EC}~\textbf{Ecuador} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.83}} & \shortstack{2--0\\[-1pt]{\tiny 1.15}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=4mm]{CI}~Ivory Coast & \shortstack{0--1\\[-1pt]{\tiny 1.04}} & \shortstack{0--1\\[-1pt]{\tiny 0.83}} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.15}} & 1 & 2 & 0 & 3 \\
4 & \worldflag[width=4mm]{CW}~Curaçao & \shortstack{0--3\\[-1pt]{\tiny 1.32}} & \shortstack{0--2\\[-1pt]{\tiny 1.15}} & \shortstack{0--2\\[-1pt]{\tiny 1.15}} & --- & 0 & 3 & -7 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{NL} & \worldflag[width=4mm]{JP} & \worldflag[width=4mm]{SE} & \worldflag[width=4mm]{TN} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{NL}~\textbf{Netherlands} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.81}} & \shortstack{1--0\\[-1pt]{\tiny 0.99}} & \shortstack{1--0\\[-1pt]{\tiny 1.04}} & 3 & 0 & $+$3 & \textbf{9} \\
2 & \worldflag[width=4mm]{JP}~\textbf{Japan} & \shortstack{0--1\\[-1pt]{\tiny 0.81}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.77}} & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=4mm]{SE}~Sweden & \shortstack{0--1\\[-1pt]{\tiny 0.99}} & \shortstack{0--1\\[-1pt]{\tiny 0.77}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.89}} & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=4mm]{TN}~Tunisia & \shortstack{0--1\\[-1pt]{\tiny 1.04}} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & \shortstack{0--1\\[-1pt]{\tiny 0.89}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{BE} & \worldflag[width=4mm]{EG} & \worldflag[width=4mm]{IR} & \worldflag[width=4mm]{NZ} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{BE}~\textbf{Belgium} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.96}} & \shortstack{1--0\\[-1pt]{\tiny 1.06}} & \shortstack{2--0\\[-1pt]{\tiny 1.12}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=4mm]{EG}~\textbf{Egypt} & \shortstack{0--1\\[-1pt]{\tiny 0.96}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.83}} & \shortstack{1--0\\[-1pt]{\tiny 1.00}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=4mm]{IR}~Iran & \shortstack{0--1\\[-1pt]{\tiny 1.06}} & \shortstack{0--1\\[-1pt]{\tiny 0.83}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.91}} & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=4mm]{NZ}~New Zealand & \shortstack{0--2\\[-1pt]{\tiny 1.12}} & \shortstack{0--1\\[-1pt]{\tiny 1.00}} & \shortstack{0--1\\[-1pt]{\tiny 0.91}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{ES} & \worldflag[width=4mm]{UY} & \worldflag[width=4mm]{CV} & \worldflag[width=4mm]{SA} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{ES}~\textbf{Spain} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.98}} & \shortstack{2--0\\[-1pt]{\tiny 1.22}} & \shortstack{2--0\\[-1pt]{\tiny 1.18}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=4mm]{UY}~\textbf{Uruguay} & \shortstack{0--1\\[-1pt]{\tiny 0.98}} & --- & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & \shortstack{1--0\\[-1pt]{\tiny 1.02}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=4mm]{CV}~Cape Verde & \shortstack{0--2\\[-1pt]{\tiny 1.22}} & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.75}} & 1 & 2 & -2 & 3 \\
4 & \worldflag[width=4mm]{SA}~Saudi Arabia & \shortstack{0--2\\[-1pt]{\tiny 1.18}} & \shortstack{0--1\\[-1pt]{\tiny 1.02}} & \shortstack{0--1\\[-1pt]{\tiny 0.75}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{FR} & \worldflag[width=4mm]{NO} & \worldflag[width=4mm]{SN} & \worldflag[width=4mm]{IQ} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{FR}~\textbf{France} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & \shortstack{1--0\\[-1pt]{\tiny 1.02}} & \shortstack{2--0\\[-1pt]{\tiny 1.35}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=4mm]{NO}~\textbf{Norway} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.88}} & \shortstack{2--0\\[-1pt]{\tiny 1.12}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=4mm]{SN}~Senegal & \shortstack{0--1\\[-1pt]{\tiny 1.02}} & \shortstack{0--1\\[-1pt]{\tiny 0.88}} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.11}} & 1 & 2 & 0 & 3 \\
4 & \worldflag[width=4mm]{IQ}~Iraq & \shortstack{0--2\\[-1pt]{\tiny 1.35}} & \shortstack{0--2\\[-1pt]{\tiny 1.12}} & \shortstack{0--2\\[-1pt]{\tiny 1.11}} & --- & 0 & 3 & -6 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{AR} & \worldflag[width=4mm]{AT} & \worldflag[width=4mm]{DZ} & \worldflag[width=4mm]{JO} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{AR}~\textbf{Argentina} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.15}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & \shortstack{2--0\\[-1pt]{\tiny 1.22}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=4mm]{AT}~\textbf{Austria} & \shortstack{0--2\\[-1pt]{\tiny 1.15}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.80}} & \shortstack{1--0\\[-1pt]{\tiny 1.07}} & 2 & 1 & 0 & \textbf{6} \\
3 & \worldflag[width=4mm]{DZ}~Algeria & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--1\\[-1pt]{\tiny 0.80}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.75}} & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=4mm]{JO}~Jordan & \shortstack{0--2\\[-1pt]{\tiny 1.22}} & \shortstack{0--1\\[-1pt]{\tiny 1.07}} & \shortstack{0--1\\[-1pt]{\tiny 0.75}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4mm]{PT} & \worldflag[width=4mm]{CO} & \worldflag[width=4mm]{UZ} & \worldflag[width=4mm]{CD} & W & L & G & P \\
\midrule
1 & \worldflag[width=4mm]{PT}~\textbf{Portugal} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & \shortstack{2--0\\[-1pt]{\tiny 1.12}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=4mm]{CO}~\textbf{Colombia} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & \shortstack{1--0\\[-1pt]{\tiny 1.06}} & \shortstack{2--0\\[-1pt]{\tiny 1.18}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=4mm]{UZ}~Uzbekistan & \shortstack{0--2\\[-1pt]{\tiny 1.12}} & \shortstack{0--1\\[-1pt]{\tiny 1.06}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.75}} & 1 & 2 & -2 & 3 \\
4 & \worldflag[width=4mm]{CD}~Congo DR & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--2\\[-1pt]{\tiny 1.18}} & \shortstack{0--1\\[-1pt]{\tiny 0.75}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \flagENG[4mm] & \worldflag[width=4mm]{HR} & \worldflag[width=4mm]{GH} & \worldflag[width=4mm]{PA} & W & L & G & P \\
\midrule
1 & \flagENG[4mm]~\textbf{England} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & \shortstack{2--0\\[-1pt]{\tiny 1.37}} & \shortstack{2--0\\[-1pt]{\tiny 1.06}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=4mm]{HR}~\textbf{Croatia} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.29}} & \shortstack{1--0\\[-1pt]{\tiny 0.99}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=4mm]{GH}~Ghana & \shortstack{0--2\\[-1pt]{\tiny 1.37}} & \shortstack{0--2\\[-1pt]{\tiny 1.29}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.84}} & 1 & 2 & -3 & 3 \\
4 & \worldflag[width=4mm]{PA}~Panama & \shortstack{0--2\\[-1pt]{\tiny 1.06}} & \shortstack{0--1\\[-1pt]{\tiny 0.99}} & \shortstack{0--1\\[-1pt]{\tiny 0.84}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
