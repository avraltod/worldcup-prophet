...
\noindent\textit{\footnotesize Predicted group table (each cell is the row team's score against the column team; G = goal difference, P = points):}

\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{MX} & \worldflag[width=4.2mm]{KR} & \worldflag[width=4.2mm]{CZ} & \worldflag[width=4.2mm]{ZA} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{MX}~\textbf{Mexico} & --- & 1--0 & 1--0 & 1--0 & 3 & 0 & $+$3 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{KR}~\textbf{South Korea} & 0--1 & --- & 1--1 & 1--0 & 1 & 1 & 0 & \textbf{4} \\
3 & \worldflag[width=3.6mm]{CZ}~Czechia & 0--1 & 1--1 & --- & 1--0 & 1 & 1 & 0 & 4 \\
4 & \worldflag[width=3.6mm]{ZA}~South Africa & 0--1 & 0--1 & 0--1 & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{CH} & \worldflag[width=4.2mm]{CA} & \worldflag[width=4.2mm]{BA} & \worldflag[width=4.2mm]{QA} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{CH}~\textbf{Switzerland} & --- & 2--1 & 1--0 & 1--0 & 3 & 0 & $+$3 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{CA}~\textbf{Canada} & 1--2 & --- & 1--0 & 1--0 & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{BA}~Bosnia and Herzegovina & 0--1 & 0--1 & --- & 1--0 & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=3.6mm]{QA}~Qatar & 0--1 & 0--1 & 0--1 & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{BR} & \worldflag[width=4.2mm]{MA} & \flagSCO[4.2mm] & \worldflag[width=4.2mm]{HT} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{BR}~\textbf{Brazil} & --- & 1--0 & 1--0 & 2--0 & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{MA}~\textbf{Morocco} & 0--1 & --- & 1--0 & 1--0 & 2 & 1 & $+$1 & \textbf{6} \\
3 & \flagSCO[3.6mm]~Scotland & 0--1 & 0--1 & --- & 1--0 & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=3.6mm]{HT}~Haiti & 0--2 & 0--1 & 0--1 & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{US} & \worldflag[width=4.2mm]{TR} & \worldflag[width=4.2mm]{PY} & \worldflag[width=4.2mm]{AU} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{US}~\textbf{United States} & --- & 1--1 & 1--0 & 1--0 & 2 & 0 & $+$2 & \textbf{7} \\
2 & \worldflag[width=3.6mm]{TR}~\textbf{Turkey} & 1--1 & --- & 1--0 & 1--0 & 2 & 0 & $+$2 & \textbf{7} \\
3 & \worldflag[width=3.6mm]{PY}~Paraguay & 0--1 & 0--1 & --- & 1--0 & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=3.6mm]{AU}~Australia & 0--1 & 0--1 & 0--1 & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{DE} & \worldflag[width=4.2mm]{EC} & \worldflag[width=4.2mm]{CI} & \worldflag[width=4.2mm]{CW} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{DE}~\textbf{Germany} & --- & 1--0 & 1--0 & 3--0 & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{EC}~\textbf{Ecuador} & 0--1 & --- & 1--0 & 2--0 & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{CI}~Ivory Coast & 0--1 & 0--1 & --- & 2--0 & 1 & 2 & 0 & 3 \\
4 & \worldflag[width=3.6mm]{CW}~Curaçao & 0--3 & 0--2 & 0--2 & --- & 0 & 3 & -7 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{NL} & \worldflag[width=4.2mm]{JP} & \worldflag[width=4.2mm]{SE} & \worldflag[width=4.2mm]{TN} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{NL}~\textbf{Netherlands} & --- & 1--0 & 1--0 & 1--0 & 3 & 0 & $+$3 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{JP}~\textbf{Japan} & 0--1 & --- & 1--0 & 1--0 & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{SE}~Sweden & 0--1 & 0--1 & --- & 1--0 & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=3.6mm]{TN}~Tunisia & 0--1 & 0--1 & 0--1 & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{BE} & \worldflag[width=4.2mm]{EG} & \worldflag[width=4.2mm]{IR} & \worldflag[width=4.2mm]{NZ} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{BE}~\textbf{Belgium} & --- & 1--0 & 1--0 & 2--0 & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{EG}~\textbf{Egypt} & 0--1 & --- & 1--0 & 1--0 & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{IR}~Iran & 0--1 & 0--1 & --- & 1--0 & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=3.6mm]{NZ}~New Zealand & 0--2 & 0--1 & 0--1 & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{ES} & \worldflag[width=4.2mm]{UY} & \worldflag[width=4.2mm]{CV} & \worldflag[width=4.2mm]{SA} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{ES}~\textbf{Spain} & --- & 1--0 & 2--0 & 2--0 & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{UY}~\textbf{Uruguay} & 0--1 & --- & 1--0 & 1--0 & 2 & 1 & $+$1 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{CV}~Cape Verde & 0--2 & 0--1 & --- & 1--0 & 1 & 2 & -2 & 3 \\
4 & \worldflag[width=3.6mm]{SA}~Saudi Arabia & 0--2 & 0--1 & 0--1 & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{FR} & \worldflag[width=4.2mm]{NO} & \worldflag[width=4.2mm]{SN} & \worldflag[width=4.2mm]{IQ} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{FR}~\textbf{France} & --- & 1--0 & 1--0 & 2--0 & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{NO}~\textbf{Norway} & 0--1 & --- & 1--0 & 2--0 & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{SN}~Senegal & 0--1 & 0--1 & --- & 2--0 & 1 & 2 & 0 & 3 \\
4 & \worldflag[width=3.6mm]{IQ}~Iraq & 0--2 & 0--2 & 0--2 & --- & 0 & 3 & -6 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{AR} & \worldflag[width=4.2mm]{AT} & \worldflag[width=4.2mm]{DZ} & \worldflag[width=4.2mm]{JO} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{AR}~\textbf{Argentina} & --- & 2--0 & 1--0 & 2--0 & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{AT}~\textbf{Austria} & 0--2 & --- & 1--0 & 1--0 & 2 & 1 & 0 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{DZ}~Algeria & 0--1 & 0--1 & --- & 1--0 & 1 & 2 & -1 & 3 \\
4 & \worldflag[width=3.6mm]{JO}~Jordan & 0--2 & 0--1 & 0--1 & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \worldflag[width=4.2mm]{PT} & \worldflag[width=4.2mm]{CO} & \worldflag[width=4.2mm]{UZ} & \worldflag[width=4.2mm]{CD} & W & L & G & P \\
\midrule
1 & \worldflag[width=3.6mm]{PT}~\textbf{Portugal} & --- & 1--0 & 2--0 & 1--0 & 3 & 0 & $+$4 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{CO}~\textbf{Colombia} & 0--1 & --- & 1--0 & 2--0 & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{UZ}~Uzbekistan & 0--2 & 0--1 & --- & 1--0 & 1 & 2 & -2 & 3 \\
4 & \worldflag[width=3.6mm]{CD}~Congo DR & 0--1 & 0--2 & 0--1 & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \flagENG[4.2mm] & \worldflag[width=4.2mm]{HR} & \worldflag[width=4.2mm]{GH} & \worldflag[width=4.2mm]{PA} & W & L & G & P \\
\midrule
1 & \flagENG[3.6mm]~\textbf{England} & --- & 1--0 & 2--0 & 2--0 & 3 & 0 & $+$5 & \textbf{9} \\
2 & \worldflag[width=3.6mm]{HR}~\textbf{Croatia} & 0--1 & --- & 2--0 & 1--0 & 2 & 1 & $+$2 & \textbf{6} \\
3 & \worldflag[width=3.6mm]{GH}~Ghana & 0--2 & 0--2 & --- & 1--0 & 1 & 2 & -3 & 3 \\
4 & \worldflag[width=3.6mm]{PA}~Panama & 0--2 & 0--1 & 0--1 & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
