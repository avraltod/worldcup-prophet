...
\input{live/champ_table}
\input{live/champdist_live}

\begin{figure}[!t]
  \caption{Champion probability distribution}\label{fig:champdist}
  \begin{threeparttable}
    {\centering
      \includegraphics[width=0.92\textwidth]{figs/fig_champion_dist.pdf}\par}
    \begin{tablenotes}\notesize
...
\input{live/divergence}

\input{live/revision_report}

\input{live/tracker}

\input{live/fixture_risk}

\input{live/risk_tracker}
...
\input{live/two_track}

\section{Discussion}

\input{live/discussion_live}
...
\input{live/groupqual_live}

\input{live/groupqual_table}
