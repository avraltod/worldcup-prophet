...
final pre-kickoff injury review 10 June (entry confirmed unchanged);
predictions locked at the 11 June kickoff. Code and data timestamped for the out-of-sample record.
\end{center}
...
\noindent\textit{\footnotesize Predicted group table (each cell: row team's score against the column team, with the prediction's expected points below; G = goal difference, P = points):}

\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{MX}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{KR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CZ}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{ZA}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{MX}}~\textbf{Mexico} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & \shortstack{1--0\\[-1pt]{\tiny 0.90}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{KR}}~\textbf{South Korea} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & \shortstack{1--1\\[-1pt]{\tiny 0.74}} & \shortstack{1--0\\[-1pt]{\tiny 0.79}} & 1 & 1 & 0 & \textbf{4} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CZ}}~Czechia & \shortstack{0--1\\[-1pt]{\tiny 0.90}} & \shortstack{1--1\\[-1pt]{\tiny 0.74}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.84}} & 1 & 1 & 0 & 4 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{ZA}}~South Africa & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--1\\[-1pt]{\tiny 0.79}} & \shortstack{0--1\\[-1pt]{\tiny 0.84}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CH}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CA}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{BA}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{QA}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CH}}~\textbf{Switzerland} & --- & \shortstack{2--1\\[-1pt]{\tiny 0.80}} & \shortstack{1--0\\[-1pt]{\tiny 1.03}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CA}}~\textbf{Canada} & \shortstack{1--2\\[-1pt]{\tiny 0.80}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.90}} & \shortstack{1--0\\[-1pt]{\tiny 1.12}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{BA}}~Bosnia and Herzegovina & \shortstack{0--1\\[-1pt]{\tiny 1.03}} & \shortstack{0--1\\[-1pt]{\tiny 0.90}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & 1 & 2 & -1 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{QA}}~Qatar & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--1\\[-1pt]{\tiny 1.12}} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{BR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{MA}} & \resizebox{!}{2.8mm}{\flagSCO[10mm]} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{HT}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{BR}}~\textbf{Brazil} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.97}} & \shortstack{1--0\\[-1pt]{\tiny 1.05}} & \shortstack{2--0\\[-1pt]{\tiny 1.37}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{MA}}~\textbf{Morocco} & \shortstack{0--1\\[-1pt]{\tiny 0.97}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.90}} & \shortstack{1--0\\[-1pt]{\tiny 1.28}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\flagSCO[10mm]}~Scotland & \shortstack{0--1\\[-1pt]{\tiny 1.05}} & \shortstack{0--1\\[-1pt]{\tiny 0.90}} & --- & \shortstack{1--0\\[-1pt]{\tiny 1.00}} & 1 & 2 & -1 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{HT}}~Haiti & \shortstack{0--2\\[-1pt]{\tiny 1.37}} & \shortstack{0--1\\[-1pt]{\tiny 1.28}} & \shortstack{0--1\\[-1pt]{\tiny 1.00}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{US}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{TR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{PY}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{AU}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{US}}~\textbf{United States} & --- & \shortstack{1--1\\[-1pt]{\tiny 0.68}} & \shortstack{1--0\\[-1pt]{\tiny 0.86}} & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & 2 & 0 & $+$2 & \textbf{7} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{TR}}~\textbf{Turkey} & \shortstack{1--1\\[-1pt]{\tiny 0.68}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.82}} & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & 2 & 0 & $+$2 & \textbf{7} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{PY}}~Paraguay & \shortstack{0--1\\[-1pt]{\tiny 0.86}} & \shortstack{0--1\\[-1pt]{\tiny 0.82}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.85}} & 1 & 2 & -1 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{AU}}~Australia & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & \shortstack{0--1\\[-1pt]{\tiny 0.85}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{DE}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{EC}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CI}} & \resizebox{!}{2.8mm}{\flagCUW[10mm]} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{DE}}~\textbf{Germany} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & \shortstack{1--0\\[-1pt]{\tiny 1.04}} & \shortstack{3--0\\[-1pt]{\tiny 1.32}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{EC}}~\textbf{Ecuador} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.83}} & \shortstack{2--0\\[-1pt]{\tiny 1.15}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CI}}~Ivory Coast & \shortstack{0--1\\[-1pt]{\tiny 1.04}} & \shortstack{0--1\\[-1pt]{\tiny 0.83}} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.15}} & 1 & 2 & 0 & 3 \\
4 & \resizebox{!}{2.8mm}{\flagCUW[10mm]}~Curaçao & \shortstack{0--3\\[-1pt]{\tiny 1.32}} & \shortstack{0--2\\[-1pt]{\tiny 1.15}} & \shortstack{0--2\\[-1pt]{\tiny 1.15}} & --- & 0 & 3 & -7 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{NL}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{JP}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{SE}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{TN}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{NL}}~\textbf{Netherlands} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.81}} & \shortstack{1--0\\[-1pt]{\tiny 0.99}} & \shortstack{1--0\\[-1pt]{\tiny 1.04}} & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{JP}}~\textbf{Japan} & \shortstack{0--1\\[-1pt]{\tiny 0.81}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.77}} & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{SE}}~Sweden & \shortstack{0--1\\[-1pt]{\tiny 0.99}} & \shortstack{0--1\\[-1pt]{\tiny 0.77}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.89}} & 1 & 2 & -1 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{TN}}~Tunisia & \shortstack{0--1\\[-1pt]{\tiny 1.04}} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & \shortstack{0--1\\[-1pt]{\tiny 0.89}} & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{BE}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{EG}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{IR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{NZ}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{BE}}~\textbf{Belgium} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.96}} & \shortstack{1--0\\[-1pt]{\tiny 1.06}} & \shortstack{2--0\\[-1pt]{\tiny 1.12}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{EG}}~\textbf{Egypt} & \shortstack{0--1\\[-1pt]{\tiny 0.96}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.83}} & \shortstack{1--0\\[-1pt]{\tiny 1.00}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{IR}}~Iran & \shortstack{0--1\\[-1pt]{\tiny 1.06}} & \shortstack{0--1\\[-1pt]{\tiny 0.83}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.91}} & 1 & 2 & -1 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{NZ}}~New Zealand & \shortstack{0--2\\[-1pt]{\tiny 1.12}} & \shortstack{0--1\\[-1pt]{\tiny 1.00}} & \shortstack{0--1\\[-1pt]{\tiny 0.91}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{ES}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{UY}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CV}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{SA}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{ES}}~\textbf{Spain} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.98}} & \shortstack{2--0\\[-1pt]{\tiny 1.22}} & \shortstack{2--0\\[-1pt]{\tiny 1.18}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{UY}}~\textbf{Uruguay} & \shortstack{0--1\\[-1pt]{\tiny 0.98}} & --- & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & \shortstack{1--0\\[-1pt]{\tiny 1.02}} & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CV}}~Cape Verde & \shortstack{0--2\\[-1pt]{\tiny 1.22}} & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.75}} & 1 & 2 & -2 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{SA}}~Saudi Arabia & \shortstack{0--2\\[-1pt]{\tiny 1.18}} & \shortstack{0--1\\[-1pt]{\tiny 1.02}} & \shortstack{0--1\\[-1pt]{\tiny 0.75}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{FR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{NO}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{SN}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{IQ}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{FR}}~\textbf{France} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & \shortstack{1--0\\[-1pt]{\tiny 1.02}} & \shortstack{2--0\\[-1pt]{\tiny 1.35}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{NO}}~\textbf{Norway} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.88}} & \shortstack{2--0\\[-1pt]{\tiny 1.12}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{SN}}~Senegal & \shortstack{0--1\\[-1pt]{\tiny 1.02}} & \shortstack{0--1\\[-1pt]{\tiny 0.88}} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.11}} & 1 & 2 & 0 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{IQ}}~Iraq & \shortstack{0--2\\[-1pt]{\tiny 1.35}} & \shortstack{0--2\\[-1pt]{\tiny 1.12}} & \shortstack{0--2\\[-1pt]{\tiny 1.11}} & --- & 0 & 3 & -6 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{AR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{AT}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{DZ}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{JO}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{AR}}~\textbf{Argentina} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.15}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & \shortstack{2--0\\[-1pt]{\tiny 1.22}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{AT}}~\textbf{Austria} & \shortstack{0--2\\[-1pt]{\tiny 1.15}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.80}} & \shortstack{1--0\\[-1pt]{\tiny 1.07}} & 2 & 1 & 0 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{DZ}}~Algeria & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--1\\[-1pt]{\tiny 0.80}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.75}} & 1 & 2 & -1 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{JO}}~Jordan & \shortstack{0--2\\[-1pt]{\tiny 1.22}} & \shortstack{0--1\\[-1pt]{\tiny 1.07}} & \shortstack{0--1\\[-1pt]{\tiny 0.75}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{PT}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CO}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{UZ}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CD}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{PT}}~\textbf{Portugal} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.95}} & \shortstack{2--0\\[-1pt]{\tiny 1.12}} & \shortstack{1--0\\[-1pt]{\tiny 1.08}} & 3 & 0 & $+$4 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CO}}~\textbf{Colombia} & \shortstack{0--1\\[-1pt]{\tiny 0.95}} & --- & \shortstack{1--0\\[-1pt]{\tiny 1.06}} & \shortstack{2--0\\[-1pt]{\tiny 1.18}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{UZ}}~Uzbekistan & \shortstack{0--2\\[-1pt]{\tiny 1.12}} & \shortstack{0--1\\[-1pt]{\tiny 1.06}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.75}} & 1 & 2 & -2 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{CD}}~Congo DR & \shortstack{0--1\\[-1pt]{\tiny 1.08}} & \shortstack{0--2\\[-1pt]{\tiny 1.18}} & \shortstack{0--1\\[-1pt]{\tiny 0.75}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
...
\noindent{\footnotesize\begin{tabular}{@{}clcccccccr@{}}
\toprule
 & Team & \resizebox{!}{2.8mm}{\flagENG[10mm]} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{HR}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{GH}} & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{PA}} & W & L & G & P \\
\midrule
1 & \resizebox{!}{2.8mm}{\flagENG[10mm]}~\textbf{England} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.94}} & \shortstack{2--0\\[-1pt]{\tiny 1.37}} & \shortstack{2--0\\[-1pt]{\tiny 1.06}} & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{HR}}~\textbf{Croatia} & \shortstack{0--1\\[-1pt]{\tiny 0.94}} & --- & \shortstack{2--0\\[-1pt]{\tiny 1.29}} & \shortstack{1--0\\[-1pt]{\tiny 0.99}} & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{GH}}~Ghana & \shortstack{0--2\\[-1pt]{\tiny 1.37}} & \shortstack{0--2\\[-1pt]{\tiny 1.29}} & --- & \shortstack{1--0\\[-1pt]{\tiny 0.84}} & 1 & 2 & -3 & 3 \\
4 & \resizebox{!}{2.8mm}{\worldflag[width=10mm]{PA}}~Panama & \shortstack{0--2\\[-1pt]{\tiny 1.06}} & \shortstack{0--1\\[-1pt]{\tiny 0.99}} & \shortstack{0--1\\[-1pt]{\tiny 0.84}} & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular}}
