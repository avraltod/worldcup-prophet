...
\begin{tikzpicture}[
  font=\scriptsize,
  >={Stealth[round]},
  io/.style={rectangle, rounded corners=2pt, draw=blue!55!black, fill=blue!6, align=left, inner sep=4pt},
  pbox/.style={rectangle, draw=black!70, fill=white, align=center, text width=142mm, inner sep=3pt, minimum height=5mm},
  learn/.style={rectangle, draw=orange!80!black, fill=orange!9, align=center, text width=142mm, inner sep=3pt},
  ...
  term/.style={rectangle, rounded corners=6pt, draw=black!85, fill=black!7, align=left, inner sep=4pt},
...
\node[draw=black!55, dashed, fill=black!2, rounded corners, below=4mm of t0, text width=142mm, align=center, inner sep=2pt] (loophead) {\textbf{LOOP} \; $\Rightarrow$ \; for each game $g$, in the order the tournament plays them};
