...
With 2 of 104 results revealed (0.002 bits of championship information), the conditional forecast diverges from the locked baseline as follows. The table lists the baseline top ten plus any team whose advance probability moved by at least three percentage points or whose champion probability moved by at least half a point; the frozen column is fixed for the whole tournament, so successive versions of this table are directly comparable.
...
Argentina & 18.1 & 17.9 & $-0.2$ & 98.9 & 98.9 & 0.0 \\
France & 14.3 & 14.3 & $+0.1$ & 98.5 & 98.5 & 0.0 \\
Portugal & 9.4 & 9.3 & $-0.1$ & 97.3 & 97.2 & 0.0 \\
England & 7.0 & 7.1 & $+0.1$ & 99.0 & 99.0 & 0.0 \\
Brazil & 3.5 & 3.6 & $+0.1$ & 98.4 & 98.3 & $-0.1$ \\
Netherlands & 2.4 & 2.3 & $-0.1$ & 91.0 & 91.1 & $+0.1$ \\
Germany & 2.2 & 2.2 & 0.0 & 98.8 & 98.8 & 0.0 \\
Ecuador & 2.0 & 2.1 & 0.0 & 87.7 & 87.6 & $-0.1$ \\
Norway & 1.7 & 1.7 & 0.0 & 89.4 & 89.4 & $+0.1$ \\
Mexico & 1.2 & 1.3 & $+0.1$ & 91.6 & 98.7 & $+7.2$ \\
South Korea & 0.1 & 0.1 & $+0.1$ & 66.2 & 92.5 & $+26.3$ \\
Czechia & 0.1 & 0.0 & 0.0 & 68.3 & 50.8 & $-17.5$ \\
