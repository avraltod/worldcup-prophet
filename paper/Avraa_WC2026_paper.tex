...
\begin{table}[!t]
  \centering
  \caption{Simulated tournament probabilities, top eight teams}\label{tab:champ}
  \begin{footnotesize}
  \begin{threeparttable}
    ...
    \end{tabular*}}
    \begin{tablenotes}\notesize
      \item \textit{Notes}: $N$ = 200{,}000; standard errors $\le$ 0.11 pp.
    \end{tablenotes}
  \end{threeparttable}
  \end{footnotesize}
\end{table}
...
\begin{figure}[!t]
  \caption{Champion probability distribution}\label{fig:champdist}
  \begin{threeparttable}
    {\centering
      \includegraphics[width=0.92\textwidth]{figs/fig1_champion_dist.pdf}\par}
    \begin{tablenotes}\notesize
      \item \textit{Notes}: Champion probability across 200{,}000 simulated tournaments. Spain (blue) is the modal champion yet fails to win in 72.6\% of simulations; Portugal (orange) is discussed in Section~\ref{sec:portugal}. The 36 teams outside the top twelve jointly retain a 9.7\% champion share.
    \end{tablenotes}
  \end{threeparttable}
\end{figure}
...
\begin{figure}[!t]
  \caption{Model and market champion odds at baseline}\label{fig:marketbase}
  \begin{threeparttable}
    {\centering
      \includegraphics[width=0.72\textwidth]{figs/fig_market_baseline.pdf}\par}
    \begin{tablenotes}\notesize
      \item \textit{Notes}: Model and market champion odds at the baseline, before any match is played. The model (blue) is more concentrated on Spain and Argentina, while the market (orange) spreads more probability to England, Brazil, and Germany. The disagreement comes entirely from the knockout stage, because the model's group-stage probabilities are themselves recovered from market odds.
    \end{tablenotes}
  \end{threeparttable}
\end{figure}
...
One finding tempers the paper's emphasis on scoreline selection. On these 128 matches the expected-value-optimal pick, the realistic readout, and a naive baseline that simply predicts a one-goal win for the favorite all score within a few points of one another: across the two years the naive baseline totals 120 (68 then 52), the expected-value pick 115 (67 then 48), and the realistic readout 119 (58 then 61). On realized results the choice of scoreline rule is therefore close to neutral for points. What the realistic readout buys is not points but fidelity to actual scores---more exact hits and closer goal totals (Section~\ref{sec:objective})---while the framework's points edge lives in the slot-emergence routing, which the 32-team format of these tournaments does not exercise and which remains validated only in simulation.
...
\begin{figure}[!t]
  ...
  \begin{threeparttable}
    {\centering
      \includegraphics[width=0.88\textwidth]{figs/fig2_slot_vs_h2h.pdf}\par}
    \begin{tablenotes}\notesize
...
\begin{table}[!t]
  \centering
  \caption{Qualification probabilities by team}\label{tab:qual}
  \begin{threeparttable}
    {\footnotesize
...
\end{minipage}}
    \begin{tablenotes}\notesize
      \item \textit{Notes}: Qualification probabilities by team (percent), 100{,}000 simulations. Columns report the probability of winning the group, finishing second, advancing as a best third-placed team ($^{*}$), and qualifying in total.
    \end{tablenotes}
  \end{threeparttable}
\end{table}
...
\begin{table}[!t]
  \centering
  \caption{Decisive fixture and primary forecast risk by group}\label{tab:watchrisk}
  \begin{footnotesize}
  \begin{threeparttable}
    {\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} p{0.5cm}p{5.4cm}p{6.6cm}}
      \toprule
    ...
    \end{tabular*}}
    \begin{tablenotes}\notesize
      \item \textit{Notes}: The decisive fixture is the match that, in the simulations, most often determines the second qualification place; the primary risk is the most probable way the submitted group order is wrong.
    \end{tablenotes}
  \end{threeparttable}
  \end{footnotesize}
\end{table}
...
{\footnotesize\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}clcccccccr@{}}
\toprule
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{MX}}~\textbf{Mexico} & --- & 2--1\,(0.88) & 2--1\,(0.84) & 2--1\,(1.02) & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{KR}}~\textbf{South Korea} & 1--2\,(0.88) & --- & 1--1\,(0.74) & 2--1\,(0.73) & 1 & 1 & 0 & \textbf{4} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CZ}}~Czechia & 1--2\,(0.84) & 1--1\,(0.74) & --- & 2--1\,(0.79) & 1 & 1 & 0 & 4 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{ZA}}~South Africa & 1--2\,(1.02) & 1--2\,(0.73) & 1--2\,(0.79) & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
\end{tablenotes}
\end{threeparttable}
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CH}}~\textbf{Switzerland} & --- & 2--1\,(0.80) & 2--1\,(0.97) & 2--1\,(1.06) & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CA}}~\textbf{Canada} & 1--2\,(0.80) & --- & 2--1\,(0.87) & 2--1\,(1.06) & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{BA}}~Bosnia and Herzegovina & 1--2\,(0.97) & 1--2\,(0.87) & --- & 2--1\,(0.89) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{QA}}~Qatar & 1--2\,(1.06) & 1--2\,(1.06) & 1--2\,(0.89) & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{BR}}~\textbf{Brazil} & --- & 2--1\,(0.94) & 2--1\,(1.02) & 2--0\,(1.37) & 3 & 0 & $+$4 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{MA}}~\textbf{Morocco} & 1--2\,(0.94) & --- & 2--1\,(0.84) & 2--0\,(1.22) & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\flagSCO[10mm]}~Scotland & 1--2\,(1.02) & 1--2\,(0.84) & --- & 2--1\,(0.99) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{HT}}~Haiti & 0--2\,(1.37) & 0--2\,(1.22) & 1--2\,(0.99) & --- & 0 & 3 & -5 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{US}}~\textbf{United States} & --- & 1--1\,(0.68) & 2--1\,(0.81) & 2--1\,(0.89) & 2 & 0 & $+$2 & \textbf{7} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{TR}}~\textbf{Turkey} & 1--1\,(0.68) & --- & 2--1\,(0.75) & 2--1\,(0.87) & 2 & 0 & $+$2 & \textbf{7} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{PY}}~Paraguay & 1--2\,(0.81) & 1--2\,(0.75) & --- & 2--1\,(0.77) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{AU}}~Australia & 1--2\,(0.89) & 1--2\,(0.87) & 1--2\,(0.77) & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{DE}}~\textbf{Germany} & --- & 2--1\,(0.91) & 2--1\,(0.98) & 3--0\,(1.32) & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{EC}}~\textbf{Ecuador} & 1--2\,(0.91) & --- & 2--1\,(0.75) & 2--1\,(1.09) & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CI}}~Ivory Coast & 1--2\,(0.98) & 1--2\,(0.75) & --- & 2--1\,(1.09) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\flagCUW[10mm]}~Curaçao & 0--3\,(1.32) & 1--2\,(1.09) & 1--2\,(1.09) & --- & 0 & 3 & -5 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{NL}}~\textbf{Netherlands} & --- & 2--1\,(0.79) & 2--1\,(0.96) & 2--1\,(0.98) & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{JP}}~\textbf{Japan} & 1--2\,(0.79) & --- & 2--1\,(0.72) & 2--1\,(0.86) & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{SE}}~Sweden & 1--2\,(0.96) & 1--2\,(0.72) & --- & 2--1\,(0.82) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{TN}}~Tunisia & 1--2\,(0.98) & 1--2\,(0.86) & 1--2\,(0.82) & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{BE}}~\textbf{Belgium} & --- & 2--1\,(0.93) & 2--1\,(1.02) & 2--1\,(1.08) & 3 & 0 & $+$3 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{EG}}~\textbf{Egypt} & 1--2\,(0.93) & --- & 2--1\,(0.75) & 2--1\,(0.92) & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{IR}}~Iran & 1--2\,(1.02) & 1--2\,(0.75) & --- & 2--1\,(0.86) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{NZ}}~New Zealand & 1--2\,(1.08) & 1--2\,(0.92) & 1--2\,(0.86) & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{ES}}~\textbf{Spain} & --- & 2--1\,(0.92) & 3--0\,(1.18) & 3--1\,(1.12) & 3 & 0 & $+$6 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{UY}}~\textbf{Uruguay} & 1--2\,(0.92) & --- & 2--1\,(1.02) & 2--1\,(0.97) & 2 & 1 & $+$1 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CV}}~Cape Verde & 0--3\,(1.18) & 1--2\,(1.02) & --- & 2--1\,(0.70) & 1 & 2 & -3 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{SA}}~Saudi Arabia & 1--3\,(1.12) & 1--2\,(0.97) & 1--2\,(0.70) & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{FR}}~\textbf{France} & --- & 2--1\,(0.90) & 2--1\,(0.95) & 3--0\,(1.31) & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{NO}}~\textbf{Norway} & 1--2\,(0.90) & --- & 2--1\,(0.82) & 3--1\,(1.07) & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{SN}}~Senegal & 1--2\,(0.95) & 1--2\,(0.82) & --- & 3--1\,(1.07) & 1 & 2 & 0 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{IQ}}~Iraq & 0--3\,(1.31) & 1--3\,(1.07) & 1--3\,(1.07) & --- & 0 & 3 & -7 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{AR}}~\textbf{Argentina} & --- & 3--1\,(1.09) & 2--1\,(0.99) & 3--0\,(1.18) & 3 & 0 & $+$6 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{AT}}~\textbf{Austria} & 1--3\,(1.09) & --- & 2--1\,(0.75) & 2--1\,(1.03) & 2 & 1 & 0 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{DZ}}~Algeria & 1--2\,(0.99) & 1--2\,(0.75) & --- & 2--1\,(0.70) & 1 & 2 & -1 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{JO}}~Jordan & 0--3\,(1.18) & 1--2\,(1.03) & 1--2\,(0.70) & --- & 0 & 3 & -5 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{PT}}~\textbf{Portugal} & --- & 2--1\,(0.59) & 3--1\,(1.07) & 2--1\,(1.05) & 3 & 0 & $+$4 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CO}}~\textbf{Colombia} & 1--2\,(0.59) & --- & 2--1\,(1.02) & 3--1\,(1.12) & 2 & 1 & $+$2 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{UZ}}~Uzbekistan & 1--3\,(1.07) & 1--2\,(1.02) & --- & 2--1\,(0.70) & 1 & 2 & -2 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{CD}}~Congo DR & 1--2\,(1.05) & 1--3\,(1.12) & 1--2\,(0.70) & --- & 0 & 3 & -4 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\midrule
1 & \resizebox{4mm}{2.7mm}{\flagENG[10mm]}~\textbf{England} & --- & 2--1\,(0.90) & 3--0\,(1.34) & 2--1\,(1.05) & 3 & 0 & $+$5 & \textbf{9} \\
2 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{HR}}~\textbf{Croatia} & 1--2\,(0.90) & --- & 3--0\,(1.26) & 2--1\,(0.95) & 2 & 1 & $+$3 & \textbf{6} \\
3 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{GH}}~Ghana & 0--3\,(1.34) & 0--3\,(1.26) & --- & 2--1\,(0.81) & 1 & 2 & -5 & 3 \\
4 & \resizebox{4mm}{2.7mm}{\worldflag[width=10mm]{PA}}~Panama & 1--2\,(1.05) & 1--2\,(0.95) & 1--2\,(0.81) & --- & 0 & 3 & -3 & 0 \\
\bottomrule
\end{tabular*}}
\begin{tablenotes}\notesize
\item \textit{Notes}: Each cell is the row team's predicted score against the column team, with the prediction's expected points in parentheses; G is goal difference and P is points.
...
\begin{table}[p]
  \centering
  \caption{Probability of reaching each stage, all 48 teams}\label{tab:survival}
  \begin{footnotesize}
  \begin{threeparttable}
...
Curaçao                &  6.8\% &  0.6\% &  0.1\% &  0.0\% &  0.0\% &  0.0\% \\
    ...
    \end{tabular*}}
    \begin{tablenotes}\notesize
      \item \textit{Notes}: Cumulative probabilities, recalibrated model, $N$ = 200{,}000.
    \end{tablenotes}
  \end{threeparttable}
  \end{footnotesize}
\end{table}
